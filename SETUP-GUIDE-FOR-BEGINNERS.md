...
- **expo-auth-session** — The piece of software that handles the actual sign-in process securely (opening the Microsoft login page and exchanging the result for a token). You don't interact with it directly — it works in the background.
